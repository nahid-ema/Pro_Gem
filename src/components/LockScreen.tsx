...
export const LockScreen: React.FC<LockScreenProps> = ({
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 flex items-center justify-center p-4 relative overflow-hidden font-sans">
      ...
      <div className="absolute -top-40 -left-40 w-96 h-96 bg-[#4F46E5]/25 rounded-sm blur-3xl pointer-events-none" />
      ...
      <div className="w-full max-w-md bg-slate-900 border border-slate-800 rounded-3xl p-6 md:p-8 shadow-sm relative z-10 space-y-6">
        ...
        <div className="text-center space-y-3">
          <div className="w-16 h-16 bg-[#4F46E5]/15 text-[#4F46E5] border border-[#4F46E5]/40 rounded-sm flex items-center justify-center mx-auto shadow-inner">
        ...
        <form onSubmit={handleLoginSubmit} className="space-y-4">
          <div className="space-y-1.5">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full bg-slate-950 border border-slate-800 focus:border-[#4F46E5] text-white pl-10 pr-4 py-3 rounded-sm text-xs font-mono font-medium focus:outline-none transition-colors"
              />
            </div>
          </div>
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative">
              ...
              <input
                ...
                placeholder="••••••••"
                className="w-full bg-slate-950 border border-slate-800 focus:border-[#4F46E5] text-white pl-10 pr-10 py-3 rounded-sm text-xs font-mono font-medium focus:outline-none transition-colors"
              />
              <button
                type="button"
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="w-full bg-[#4F46E5] text-white hover:bg-[#4338CA] py-3.5 rounded-sm font-bold text-xs shadow-none shadow-[#4F46E5]/25 transition-all active:scale-[0.98] flex items-center justify-center gap-2 cursor-pointer disabled:opacity-50 mt-2"
          >
            {isLoading ? (
