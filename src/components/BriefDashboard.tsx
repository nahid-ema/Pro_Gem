    ...
    <div className="space-y-6 animate-fadeIn pb-4">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 relative rounded-3xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-6 sm:p-8 shadow-sm overflow-hidden flex flex-col justify-center">
          <div className="absolute top-0 right-0 w-64 h-64 bg-indigo-400/10 dark:bg-indigo-500/10 blur-3xl rounded-full pointer-events-none -translate-y-1/2 translate-x-1/3" />
          ...
          <div className="flex items-center gap-4 sm:gap-6 z-10">
            ...
            <div>
              <h2 className="text-xl sm:text-2xl md:text-3xl font-extrabold text-slate-800 dark:text-slate-100 tracking-tight leading-snug">
                {language === 'bn' ? (
                  <>শুভ দিন! <span className="text-[#4F46E5] dark:text-indigo-400 font-black">নাহিদ কুটির</span></>
                ) : (
                  <>Good Day! <span className="text-[#4F46E5] dark:text-indigo-400 font-black">Nahid Kutir</span></>
                )}
              </h2>
        ...
        <div className="lg:col-span-2 relative rounded-3xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-6 sm:p-8 shadow-sm flex flex-col justify-center">
          <div className="flex flex-wrap items-center justify-between gap-4 mb-6 sm:mb-8">
            <div className="flex items-center gap-3.5">
              <div className="w-12 h-12 rounded-full bg-indigo-50 dark:bg-indigo-900/30 text-indigo-600 dark:text-indigo-400 flex items-center justify-center border border-indigo-100 dark:border-indigo-800/30">
          ...
          <div className="relative h-6 sm:h-8 bg-slate-100 dark:bg-slate-800/80 rounded-full overflow-hidden mb-5 shadow-inner border border-slate-200/60 dark:border-slate-700/60">
            <div 
              className="absolute top-0 left-0 h-full bg-gradient-to-r from-indigo-600 via-indigo-500 to-rose-500 rounded-full transition-all duration-1000 ease-out flex items-center justify-end px-3"
          ...
          <div className="flex items-center justify-between">
            ...
            {collectionPercentage < 15 && (
              <span className="text-xs font-black text-indigo-600 dark:text-indigo-400 bg-indigo-50 dark:bg-indigo-900/40 px-3 py-1 rounded-full shadow-sm border border-indigo-100 dark:border-indigo-800/50">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-5 sm:gap-6">
        ...
        <div className="relative rounded-3xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-6 shadow-sm">
          <div className="flex items-center gap-3 mb-4 sm:mb-5">
            <div className="w-9 h-9 rounded-full bg-indigo-50 dark:bg-indigo-900/30 text-indigo-600 dark:text-indigo-400 flex items-center justify-center border border-indigo-100/50 dark:border-indigo-800/50 shadow-sm">
