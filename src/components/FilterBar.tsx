        ...
        <div className="flex items-center gap-2 w-full lg:w-auto shrink-0">
          ...
          <div className="relative shrink-0" ref={datePickerRef}>
            <button
              ...
              className="flex items-center justify-center gap-1.5 px-3 py-1.5 rounded-full bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-800 dark:text-slate-100 border border-slate-200 dark:border-slate-700 text-xs font-bold transition-all cursor-pointer shrink-0 shadow-2xs active:scale-95"
            >
              <Calendar className="w-3.5 h-3.5 text-[#e0533c] shrink-0" />
          ...
          <div className="relative shrink-0" ref={quickNavRef}>
            <button
              ...
              className="flex items-center justify-center gap-1.5 px-3 py-1.5 rounded-full bg-[#e0533c]/10 hover:bg-[#e0533c]/20 text-[#e0533c] border border-[#e0533c]/30 text-xs font-bold transition-all cursor-pointer shrink-0 shadow-2xs active:scale-95"
            >
            ...
            {isQuickNavOpen && (
              <div className="absolute left-0 mt-2 w-52 sm:w-56 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl shadow-xl z-50 p-1.5 space-y-0.5 animate-in fade-in zoom-in-95 duration-150">
