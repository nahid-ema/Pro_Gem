...
export const AndroidInstallModal: React.FC<AndroidInstallModalProps> = ({ isOpen, onClose, language }) => {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-slate-900/70 backdrop-blur-xs animate-in fade-in duration-200">
      <div className="bg-white dark:bg-[#1A1A1A]/80 border border-[#E8E6E1] dark:border-[#333333] rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.08)] w-full max-w-md overflow-hidden flex flex-col max-h-[90vh]">
        
        {/* Modal Header */}
        <div className="p-5 bg-gradient-to-r from-[#0EA5E9] to-[#D49D1A] text-white flex items-center justify-between shrink-0">
        ...
        <div className="p-5 overflow-y-auto space-y-5 text-slate-800 dark:text-slate-200 text-xs sm:text-sm">
          ...
          {isInstalled ? (
            ...
            <div className="p-4 bg-gradient-to-br from-[#0EA5E9]/10 to-amber-500/10 border border-[#0EA5E9]/30 rounded-2xl space-y-3">
              <div className="flex items-center gap-2 text-[#0EA5E9] font-bold text-sm">
                <i className="fi fi-sr-bolt text-base fill-[#0EA5E9]" />
              ...
              <button
                ...
                className="w-full py-2.5 px-4 bg-[#0EA5E9] text-slate-900 hover:bg-[#0284C7] font-bold rounded-xl shadow-md transition-all flex items-center justify-center gap-2 cursor-pointer active:scale-95"
              >
          ...
          <div className="space-y-3">
            <h4 className="font-bold text-slate-900 dark:text-white flex items-center gap-2 text-xs uppercase tracking-wider text-[#0EA5E9]">
            ...
            <div className="space-y-2.5">
              ...
              <div className="flex items-start gap-3 p-3 bg-slate-50 dark:bg-slate-800/60 rounded-2xl border border-slate-100 dark:border-slate-800">
                <div className="w-6 h-6 rounded-full bg-[#0EA5E9] text-slate-900 font-bold flex items-center justify-center shrink-0 text-xs">
                  ১
                </div>
              ...
              <div className="flex items-start gap-3 p-3 bg-slate-50 dark:bg-slate-800/60 rounded-2xl border border-slate-100 dark:border-slate-800">
                ...
                <div className="space-y-1">
                  <div className="font-bold text-slate-800 dark:text-slate-200 flex items-center gap-1.5">
                    ...
                    <i className="fi fi-sr-square-plus text-base text-[#0EA5E9] inline" />
                  </div>
                  <p className="text-slate-500 dark:text-slate-400 text-xs">
                    {isBn 
