  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-slate-900/80 animate-in fade-in duration-200">
      <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl shadow-xl w-full max-w-md overflow-hidden flex flex-col max-h-[90vh]">
        ...
        {/* Modal Header */}
        <div className="p-5 bg-gradient-to-r from-[#4F46E5] to-[#D49D1A] text-white flex items-center justify-between shrink-0">
        ...
        <div className="p-5 overflow-y-auto space-y-5 text-slate-800 dark:text-slate-200 text-xs sm:text-sm">
          ...
          {isInstalled ? (
            ...
            <div className="p-4 bg-gradient-to-br from-[#4F46E5]/10 to-amber-500/10 border border-[#4F46E5]/30 rounded-sm space-y-3">
              <div className="flex items-center gap-2 text-[#4F46E5] font-bold text-sm">
                <i className="fi fi-sr-bolt text-base fill-[#4F46E5]" />
              ...
              <button
                ...
                className="w-full py-2.5 px-4 bg-[#4F46E5] text-white hover:bg-[#4338CA] font-bold rounded-sm shadow-none transition-all flex items-center justify-center gap-2 cursor-pointer active:scale-95"
              >
          ...
          <div className="space-y-3">
            <h4 className="font-bold text-slate-900 dark:text-white flex items-center gap-2 text-xs uppercase tracking-wider text-[#4F46E5]">
            ...
            <div className="space-y-2.5">
              ...
              <div className="flex items-start gap-3 p-3 bg-[#EBE7E0] dark:bg-slate-800/60 rounded-sm border border-[#D6D0C4] dark:border-slate-800">
                <div className="w-6 h-6 rounded-sm bg-[#4F46E5] text-white font-bold flex items-center justify-center shrink-0 text-xs">
                  ১
                </div>
              ...
              <div className="flex items-start gap-3 p-3 bg-[#EBE7E0] dark:bg-slate-800/60 rounded-sm border border-[#D6D0C4] dark:border-slate-800">
                ...
                <div className="space-y-1">
                  <div className="font-bold text-slate-800 dark:text-slate-200 flex items-center gap-1.5">
                    ...
                    <i className="fi fi-sr-square-plus text-base text-[#4F46E5] inline" />
                  </div>
                  <p className="text-slate-500 dark:text-slate-400 text-xs">
                    {isBn 
          ...
          <div className="p-3.5 bg-[#F2F0EB] dark:bg-[#2A2A2A]/80 rounded-sm border border-[#D6D0C4]/80 dark:border-slate-700/80 space-y-2">
            ...
            <ul className="grid grid-cols-1 gap-1.5 text-xs text-slate-600 dark:text-slate-400">
              <li className="flex items-center gap-2">
                <span className="w-1.5 h-1.5 rounded-sm bg-[#4F46E5]" />
