...
export const RentSection: React.FC<RentSectionProps> = ({
  ...
  return (
    <div className="bg-white/80 backdrop-blur-xl dark:bg-[#1A1A1A]/80 border border-[#E8E6E1] dark:border-[#333333] rounded-2xl md:rounded-3xl p-5 md:p-6 mb-6 shadow-sm">
      ...
      <div className="flex items-center justify-between pb-4 mb-4 border-b border-slate-100 dark:border-slate-800">
        <div className="flex items-center gap-3">
          <div className="w-9 h-9 rounded-2xl bg-[#F4C542]/10 text-[#F4C542] dark:text-[#F4C542] flex items-center justify-center font-bold text-base">
            <i className="fi fi-br-money-bill-wave" />
          </div>
          <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-3 py-2 rounded-lg border border-slate-300 dark:border-slate-700 bg-slate-100 dark:bg-[#2A2A2A]/60 text-xs md:text-sm font-bold text-slate-700 dark:text-slate-300"
              />
            </div>
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-3 py-2 rounded-lg border border-slate-300 dark:border-slate-700 bg-slate-100 dark:bg-[#2A2A2A]/60 text-xs md:text-sm text-slate-700 dark:text-slate-300"
              />
            </div>
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-3 py-2 rounded-lg border border-slate-300 dark:border-slate-700 bg-slate-100 dark:bg-[#2A2A2A]/60 text-xs md:text-sm font-bold text-rose-600"
              />
            </div>
      ...
      {/* Table */}
      <div className="overflow-x-auto rounded-xl border border-[#E8E6E1] dark:border-[#333333] max-h-[500px]">
        <table className="w-full text-left text-xs md:text-sm border-collapse">
          <thead className="sticky top-0 bg-slate-50 dark:bg-slate-800/90 text-slate-500 dark:text-slate-400 uppercase text-[11px] font-bold tracking-wider border-b border-[#E8E6E1] dark:border-[#333333] shadow-sm z-10">
            <tr>
                      ...
                      {isPaid ? (
                        ...
                        <div className="flex items-center gap-1">
                          <span className="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full bg-rose-100 text-rose-700 dark:bg-rose-950/60 dark:text-rose-300 font-bold text-[10px] uppercase">
                            <i className="fi fi-br-triangle-warning text-xs" />
                    ...
                    <td className="p-3 no-print text-right">
                      <div className="flex items-center justify-end gap-1.5">
                        <button
                          ...
                          title={t.receiptBtn}
                        >
                          <i className="fi fi-br-receipt text-sm" />
                        </button>
                        <button
