    ...
    <div id="receiptModalOverlay" className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 bg-slate-900/60 backdrop-blur-sm animate-fadeIn overflow-y-auto">
      ...
      >
        <div style={{
          ...
          {/* Thank you */}
          <p style={{ textAlign: 'center', fontSize: '13px', color: '#64748b', fontWeight: '600', fontStyle: 'italic', margin: '0 0 24px 0', lineHeight: '1.4' }}>
            "{t.thankYouMsg}"
          </p>

          {/* Signatures */}
          <table style={{ width: '100%', marginTop: '24px', marginBottom: '20px' }}>
            <tbody>
              <tr>
